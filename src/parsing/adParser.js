...
const LISTING_CATEGORY_RULES = [
  { code: 'transport', name: 'Авто', keywords: ['авто', 'машин', 'автомоб', 'toyota', 'bmw', 'mercedes', 'lada', 'kia', 'hyundai', 'ваз', 'пробег', 'двигател', 'акпп', 'мкпп', 'vin', 'л/с', 'мотор', 'привод', 'механика', 'бампер', 'mazda', 'мазда', 'lexus', 'лексус', 'nissan', 'ниссан', 'audi', 'ауди', 'honda', 'хонда', 'renault', 'рено', 'ford', 'форд', 'volkswagen', 'фольксваген', 'skoda', 'шкода', 'subaru', 'субару', 'uaz', 'уаз', 'volvo', 'вольво', 'opel', 'опель', 'chevrolet', 'шевроле', 'mitsubishi', 'митсубиши', 'без гнил', 'кузов'] },
  ...
  { code: 'electronics', name: 'Электроника', keywords: ['iphone', 'айфон', 'samsung', 'xiaomi', 'телефон', 'смартфон', 'ноутбук', 'macbook', 'пк', 'playstation', 'ps5', 'ipad', 'наушник', 'xbox', 'x box', 'poco', 'redmi', 'редми', 'realme', 'реалми', 'oppo', 'vivo', 'huawei', 'хуавей', 'honor', 'хонор', 'планшет', 'колонк', 'алис', 'смарт'] },
  { code: 'jobs', name: 'Работа', keywords: ['ваканси', 'зарплат', 'требуетс', 'сотрудник', 'резюме', 'вакансия', 'ищу работу', 'ищем работу', 'подработк', 'устроиться'] },
